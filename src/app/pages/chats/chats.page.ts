...
export class ChatsPage implements OnInit {
  private mediaFile: MediaObject | null = null; ;
...
public dbInstance!: SQLiteObject;
  ...
  stopAudio() {
    ...
    if (this.mediaFile) {
      ...
      this.mediaFile = null; // الآن لا يوجد خطأ TypeScript
  ...
  seekAudio(event: any) {
    if (this.mediaFile) {
      let newPosition = event.detail.value * 1000;
      this.mediaFile.seekTo(newPosition);
    }
  }
